...
import LogViewerSimple from '@/components/LogViewerSimple.vue'
    ...
    <div style="width: 100vw; height: 100vh; padding: 20px">
      <NTabs type="line" placement="top">
        <NTabPane name="settings" tab="设置">
          ...
          <div style="margin: 20px 0">
            智谱 API Key
            <a href="https://open.bigmodel.cn/usercenter/proj-mgmt/apikeys" target="_blank"
              >点击获取</a
            >
